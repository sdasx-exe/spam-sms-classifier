...
├── Spam_Classifier_Project_Report.docx
└── README.md
```
...
```bash
conda create -n spam_env python=3.14 -y
...
Full report available: [Spam_Classifier_Project_Report.docx](Spam_Classifier_Project_Report.docx)
